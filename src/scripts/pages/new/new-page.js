        ...
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            <div class="form-control">
              <label for="description-input" class="new-form__description__title">Berbagi Cerita</label>
  
              <div class="new-form__description__container">
                <textarea
                  id="description-input"
                  name="description"
                  placeholder="Isi lembar kosong ini dengan cerita Anda..."
                ></textarea>
              </div>
            </div>
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Foto / Gambar</label>
...
   #updateLatLngInput(lat, lon) {
    // Check if lat and lon are defined before assigning
    if (lat !== undefined && lon !== undefined) {
      this.#form.elements.namedItem('latitude').value = lat;
      this.#form.elements.namedItem('longitude').value = lon;
    } else {
      console.warn('Attempted to update Lat/Lng input with undefined values.', { lat, lon });
    }
  }
